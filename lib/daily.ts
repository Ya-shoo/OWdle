...
// produced by the melee labeler → `npm run sync-melee`). Unlike sound mode
// there's exactly one clip per hero, so the daily pick is just a hero. WIP
// (built:false in lib/modes.ts) — not in the daily rotation yet.
// ─────────────────────────────────────────────────────────────────────────
