    ...
    <header className="border-b border-line bg-canvas">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-5 sm:gap-7">
          ...
          <NextResetCountdown
            label="next"
            className="utility-label flex flex-col items-end leading-tight text-[10px] text-info min-[380px]:flex-row min-[380px]:items-baseline min-[380px]:gap-1 min-[380px]:leading-none sm:text-xs"
          />
          <HeaderProgress />
        </div>
      </div>
