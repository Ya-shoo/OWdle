...
// Home-page FAQ. Native <details>/<summary> so the answer copy is always
...
// de-gradiented UI. The matching FAQPage JSON-LD is emitted from app/page.tsx
// off the same HOME_FAQ source, so the visible copy and the structured data
  ...
  return (
    <section className="mx-auto max-w-3xl px-6 pb-20 pt-4">
      <div className="mb-6 border-b border-line pb-3">
        <h2 className="font-soft text-2xl font-bold text-ink">
